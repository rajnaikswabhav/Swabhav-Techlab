...
{
    [Table("LUCKYDRAWVISITOR")]
    public class LuckyDrawVisitor : MasterEntity
    {
        ...
        public LuckyDrawVisitor(string firstName, string lastName, string address, string mobileNo, int pinCode, string emailId, string dateOfBirth, bool gender, string education, string income, string facebookId)
        {
        ...
        public static LuckyDrawVisitor Create(string firstName, string lastName, string address, string mobileNo, int pinCode, string emailId, string dateOfBirth, bool gender, string education, string income, string facebookId)
        {
            return new LuckyDrawVisitor(firstName, lastName, address, mobileNo, pinCode, emailId, dateOfBirth, gender, education, income, facebookId);
        }
